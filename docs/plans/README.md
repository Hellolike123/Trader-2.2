...
| **obsolete 杀开关** | **禁止再做**的方向 | 报告四区重组（已归档，走 git 历史；勿重开） |
...
4. [`wyckoff-phase-fail-copy-handoff.md`](./wyckoff-phase-fail-copy-handoff.md) — 失效人话  
5. 需要时：[`wyckoff-weekly-scan-windows-handoff.md`](./wyckoff-weekly-scan-windows-handoff.md)（B 卡深析 / P&F 已归档，走 git 历史）  
6. SC/ST 现行默认数值：[`wyckoff-tr-maturity-l0l3-handoff.md`](./wyckoff-tr-maturity-l0l3-handoff.md) §4（PR #55 松参样本已归档，走 git 历史）

### 缠论

1. [`BUSINESS.md`](../../BUSINESS.md) §2.0 / §2.1  
2. [`chanlun-skill-slim-b-handoff.md`](./chanlun-skill-slim-b-handoff.md) — 默认 B·中剪报告  
3. 算法：[`formulas.md`](../../02-共享模块-shared/trader_shared/formulas.md) §2–§6 / §4.1 / §9.1（深卡 / playbook 已归档，走 git 历史）

### 交易员面板

1. [`BUSINESS.md`](../../BUSINESS.md) §4.0 / §5.1  
2. [`trader-panel-declutter-handoff.md`](./trader-panel-declutter-handoff.md) — 关闭态动词净化  
3. **禁止**：报告四区重组（已归档，勿重开）
...
已归档的深卡 / B 卡骨架 / P&F / playbook / 阶段行 / 四区禁令不再以文件链接为准，考古走 git 历史。
...
例：`done/range-diff-fixes-handoff.md`、`done/wyckoff-phase-accuracy-handoff-2026-07-31.md`。

### 历史 handoff（已归档）

架构收口（#50–#53）、威科夫灵敏度（#55）等历史 handoff 已移出工作树，考古走 git 历史。
